...
* 手机影视神器，摆脱爱奇艺、优酷、腾讯平台的长时间广告骚扰和会员限制：[小小影视永久官网](http://www.wangdunwen.com/?inviteCode=ID3WVM)、[南瓜影视永久官网](https://ng33.app/?channelCode=share?appkey=ayo1id&recommend=20965059)、[冬瓜影视永久官网](https://dg77.app/?channelCode=share?appkey=zphsu3&recommend=4897090)<br>[卧龙影视官网(邀请码：WL345597)](https://www.wolong.tv)<br>
| 左对齐 | 右对齐 | 居中对齐 |
| :-----| ----: | :----: |
| 单元格 | 单元格 | 单元格 |
| 单元格 | 单元格 | 单元格 |
...
| 影片片头是否有广告 | 片头有7s广告和小小影视的logo加载 | 单元格 | 片头有5s广告，可点击跳过 | 同南瓜影视 |
| 打开APP是否有广告 | 打开APP有7s广告，但可点击跳过 | 单元格 | 打开APP有5s广告，无法跳过 | 同南瓜影视 |
